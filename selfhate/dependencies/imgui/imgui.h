...
namespace ImGui
{
    ...
    IMGUI_API bool          tabEx(bool selected, const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          tab(bool selected, const char* label, const ImVec2& size = ImVec2(0, 0));
