...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    const ImVec2 pos = window->DC.CursorPos;
    const ImRect total_bb(pos + ImVec2(5, 0), pos + ImVec2(square_sz + 12 + label_size.x, (label_size.y > square_sz) ? label_size.y - 5 : square_sz));
    ItemSize(total_bb, style.FramePadding.y);
    ...
    if (*v)
        window->DrawList->AddRectFilledMultiColor(total_bb.Min, total_bb.Min + ImVec2(square_sz, square_sz), ImColor(255, 255, 255), ImColor(240, 240, 240), ImColor(255, 255, 255), ImColor(240, 240, 240));

    window->DrawList->AddRect(total_bb.Min, total_bb.Min + ImVec2(square_sz, square_sz), ImColor(255, 255, 255, 15));

    window->DrawList->AddText(ImVec2(total_bb.Max.x - label_size.x - 5, total_bb.Min.y - 4), ImColor(255, 255, 255), label);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    const float size = ImGui::GetWindowWidth() - 25;

    const ImRect rect(window->DC.CursorPos + ImVec2(5, 0), window->DC.CursorPos + ImVec2(size, 36));
    const ImRect clickable(window->DC.CursorPos + ImVec2(5, 18), window->DC.CursorPos + ImVec2(size, 36));
    ...
    window->DrawList->AddRectFilled(clickable.Min, clickable.Max, ImColor(35, 35, 35));
    window->DrawList->AddRect(clickable.Min, clickable.Max, ImColor(255, 255, 255, 15));
    ...
    window->DrawList->AddText(clickable.Min + ImVec2(5, 2), ImColor(255, 255, 255), preview_value);
    ...
    PushStyleColor(ImGuiCol_Border, ImVec4(ImColor(255, 255, 255, 15)));
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    window->DrawList->AddRectFilledMultiColor(frame_bb.Min, { grab_bb.Min.x + 3, frame_bb.Max.y }, ImColor(255, 255, 255), ImColor(240, 240, 240), ImColor(255, 255, 255), ImColor(240, 240, 240));
